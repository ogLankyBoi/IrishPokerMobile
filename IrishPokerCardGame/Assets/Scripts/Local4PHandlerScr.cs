...
public class Local4PHandlerScr : MonoBehaviour
{
    ...
    void Deal()
    {
        ...
        for (int i = 4; i < 8; i++)
        {
            GameObject newCard = Instantiate(cardPrefab, new Vector3(60, 1200 + yOffset, zOffset), Quaternion.identity);
            newCard.name = deck[i];
        ...
        for (int i = 12; i < 16; i++)
        {
            ...
            GameObject newCard = Instantiate(cardPrefab, new Vector3(1020, 840 + yOffset, zOffset), Quaternion.identity);
            newCard.name = deck[i];
            GameObject.Find(deck[i]).transform.Rotate(0f, 0f, 90f);
    ...
    IEnumerator decideWhoRidesBus()
    {
        ...
        if ((playerScore1Val == playerScore2Val && playerScore1Val == playerScore3Val && playerScore1Val == playerScore4Val) || (playerScore1Val == playerScore2Val && playerScore1Val > playerScore3Val && playerScore1Val > playerScore4Val) || (playerScore1Val == playerScore3Val && playerScore1Val > playerScore2Val && playerScore1Val > playerScore4Val) || (playerScore1Val == playerScore4Val && playerScore1Val > playerScore3Val && playerScore1Val > playerScore2Val) || (playerScore3Val == playerScore2Val && playerScore2Val > playerScore1Val && playerScore2Val > playerScore4Val) || (playerScore4Val == playerScore2Val && playerScore2Val > playerScore1Val && playerScore2Val > playerScore3Val) || (playerScore3Val == playerScore4Val && playerScore3Val > playerScore1Val && playerScore3Val > playerScore2Val) || (playerScore1Val == playerScore2Val && playerScore1Val == playerScore3Val && playerScore1Val > playerScore4Val) || (playerScore1Val == playerScore2Val && playerScore1Val > playerScore3Val && playerScore1Val == playerScore4Val) || (playerScore1Val > playerScore2Val && playerScore1Val == playerScore3Val && playerScore1Val == playerScore4Val) || (playerScore3Val == playerScore2Val && playerScore3Val == playerScore4Val && playerScore1Val < playerScore4Val))
        {
    ...
    IEnumerator BusTie()
    {
        ...
        ShuffleDeck(tieDeck);
        if (playerScore1Val == playerScore2Val && playerScore1Val == playerScore3Val && playerScore1Val == playerScore4Val)
        {
            for (int i = 0; i < 52; i++)
            {
                ...
                {
                    GameObject tieCard = Instantiate(cardPrefab, new Vector3(180, 1000, 0), Quaternion.identity);
                    tieCard.name = tieDeck[i];
                    if (i != 1)
                    {
                        Destroy(GameObject.Find(tieDeck[i - 4]));
                ...
                {
                    GameObject tieCard = Instantiate(cardPrefab, new Vector3(900, 1000, 0), Quaternion.identity);
                    tieCard.name = tieDeck[i];
                    if (i != 3)
                    {
                        Destroy(GameObject.Find(tieDeck[i - 4]));
        ...
        else if (playerScore1Val == playerScore2Val && playerScore1Val == playerScore4Val)
        {
            for (int i = 0; i < 52; i++)
            {
                if (i == 0 || i == 3 || i == 6 || i == 9 || i == 12 || i == 15 || i == 18 || i == 21 || i == 24 || i == 27 || i == 30 || i == 33 || i == 36 || i == 39 || i == 42 || i == 45 || i == 48 || i == 51)
        ...
        else if (playerScore1Val == playerScore4Val && playerScore1Val == playerScore3Val)
        {
            for (int i = 0; i < 52; i++)
            {
                if (i == 0 || i == 3 || i == 6 || i == 9 || i == 12 || i == 15 || i == 18 || i == 21 || i == 24 || i == 27 || i == 30 || i == 33 || i == 36 || i == 39 || i == 42 || i == 45 || i == 48 || i == 51)
        ...
        else if (playerScore4Val == playerScore2Val && playerScore2Val == playerScore3Val)
        {
            for (int i = 0; i < 52; i++)
            {
                if (i == 0 || i == 3 || i == 6 || i == 9 || i == 12 || i == 15 || i == 18 || i == 21 || i == 24 || i == 27 || i == 30 || i == 33 || i == 36 || i == 39 || i == 42 || i == 45 || i == 48 || i == 51)
        ...
        else if (playerScore1Val == playerScore3Val && playerScore1Val > playerScore2Val && playerScore1Val > playerScore4Val)
        {
            for (int i = 0; i < 52; i++)
            {
                if (i % 2 == 0)
        ...
        else if (playerScore1Val == playerScore4Val && playerScore1Val > playerScore2Val && playerScore1Val > playerScore3Val)
        {
            for (int i = 0; i < 52; i++)
            {
                if (i % 2 == 0)
        ...
        else if (playerScore2Val == playerScore3Val && playerScore2Val > playerScore1Val && playerScore2Val > playerScore4Val)
        {
            for (int i = 0; i < 52; i++)
            {
                if (i % 2 == 0)
        ...
        else if (playerScore2Val == playerScore4Val && playerScore2Val > playerScore3Val && playerScore2Val > playerScore1Val)
        {
            for (int i = 0; i < 52; i++)
            {
                if (i % 2 == 0)
        ...
        else if (playerScore3Val == playerScore4Val && playerScore3Val > playerScore1Val && playerScore3Val > playerScore2Val)
        {
            for (int i = 0; i < 52; i++)
            {
                if (i % 2 == 0)
    ...
    public void ChangeCardPlacements()
    {
        ...
        playerMarkerRed.transform.position = playerMarkerYellow.transform.position;
        ...
        scoreBackground1.transform.position = scoreBackground4.transform.position;
        ...
        GameObject.Find(deck[0]).transform.position = new Vector3(GameObject.Find(deck[12]).GetComponent<TransformCardPosition>().cardPos.x, GameObject.Find(deck[12]).GetComponent<TransformCardPosition>().cardPos.y, GameObject.Find(deck[12]).GetComponent<TransformCardPosition>().cardPos.z);
        GameObject.Find(deck[0]).GetComponent<TransformCardPosition>().cardPos = GameObject.Find(deck[12]).GetComponent<TransformCardPosition>().cardPos;
        ...
        GameObject.Find(deck[1]).transform.position = new Vector3(GameObject.Find(deck[13]).GetComponent<TransformCardPosition>().cardPos.x, GameObject.Find(deck[13]).GetComponent<TransformCardPosition>().cardPos.y, GameObject.Find(deck[13]).GetComponent<TransformCardPosition>().cardPos.z);
        GameObject.Find(deck[1]).GetComponent<TransformCardPosition>().cardPos = GameObject.Find(deck[13]).GetComponent<TransformCardPosition>().cardPos;
        ...
        GameObject.Find(deck[2]).transform.position = new Vector3(GameObject.Find(deck[14]).GetComponent<TransformCardPosition>().cardPos.x, GameObject.Find(deck[14]).GetComponent<TransformCardPosition>().cardPos.y, GameObject.Find(deck[14]).GetComponent<TransformCardPosition>().cardPos.z);
        GameObject.Find(deck[2]).GetComponent<TransformCardPosition>().cardPos = GameObject.Find(deck[14]).GetComponent<TransformCardPosition>().cardPos;
        ...
        GameObject.Find(deck[3]).transform.position = new Vector3(GameObject.Find(deck[15]).GetComponent<TransformCardPosition>().cardPos.x, GameObject.Find(deck[15]).GetComponent<TransformCardPosition>().cardPos.y, GameObject.Find(deck[15]).GetComponent<TransformCardPosition>().cardPos.z);
        GameObject.Find(deck[3]).GetComponent<TransformCardPosition>().cardPos = GameObject.Find(deck[15]).GetComponent<TransformCardPosition>().cardPos;
    ...
    public void OnContinueButton()
    {
        if (round <= 5)
        {
            ...
            else if (round == 5)
            {
                ...
                else if (playerScore2Val > playerScore1Val && playerScore2Val > playerScore3Val && playerScore2Val > playerScore4Val)
                {
                    dialogueText.GetComponent<Text>().text = "Blue lost! Ready to ride the bus?";
                }
                else if (playerScore3Val > playerScore1Val && playerScore3Val > playerScore2Val && playerScore3Val > playerScore4Val)
                {
                    dialogueText.GetComponent<Text>().text = "Green lost! Ready to ride the bus?";
                }
                else if (playerScore4Val > playerScore1Val && playerScore4Val > playerScore2Val && playerScore4Val > playerScore3Val)
                {
